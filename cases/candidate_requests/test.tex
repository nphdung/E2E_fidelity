...
\begin{axis}[
    ...
    xlabel={\large{Number of requests}},
    ylabel={\large{Number of met requests}},
    %legend entries={Opt$\_$MCLP$(\alpha=1)$, Opt$\_$MCLP$(\alpha=10)$, Opt$\_$MCLP$(\alpha=100)$},
    legend entries={$K=6$,$K=5$,$K=4$,$K=3$},
    xmin=50,
    ymin=30,
    xmax=70,
    ymax=45,
    xtick={50,55,60,65,70},
    %ytick={0,20,40,60,80,100,120},
    legend pos=north west, %outer north east, north west, north east, south west, south east
    ymajorgrids=true,
